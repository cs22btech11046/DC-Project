...
void handle_client(int sock) {
    ...
    string scheduler_ip = "UNKNOWN"; // additional field
    ...
    if (cmd == "PROBE") {
        ...
        cout << "[worker] Received ASSIGN from " << scheduler_ip
             << " | duration=" << dur << "ms" 
             << " | current queue=" << queue_len.load() << endl;
        ...
        cout << "[worker] Received REQUEST from " << scheduler_ip
             << " | duration=" << dur << "ms"
             << " | current queue=" << queue_len.load() << endl;
